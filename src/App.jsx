    ...
    <>
      <div className='w-full py-28 flex flex-col gap-6'>
        ...
        <section className='flex flex-row gap-5'>
          <a target="_blank" href="https://github.com/matibe95" className='contact-buttons boton-principal flex gap-2 items-center justify-center px-3 py-2 bg-[#e1e1dd] rounded-lg' rel="noreferrer">
          ...
          <a href="cv-matias-bellini.pdf" download className='contact-buttons boton-principal flex gap-2 items-center justify-center px-3 py-2 bg-[#e1e1dd] rounded-lg' rel="noreferrer">
          <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="20px" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M20 2C21.6569 2 23 3.34315 23 5V7H21V19C21 20.6569 19.6569 22 18 22H4C2.34315 22 1 20.6569 1 19V17H17V19C17 19.5128 17.386 19.9355 17.8834 19.9933L18 20C18.5128 20 18.9355 19.614 18.9933 19.1166L19 19V4H6C5.48716 4 5.06449 4.38604 5.00673 4.88338L5 5V15H3V5C3 3.34315 4.34315 2 6 2H20Z"></path></svg>
              CV
          </a>
          <a target="_blank" href="mailto:matibel2005@gmail.com?Subject=Hola%20estoy%20interesado%20hablar%20contigo!" className='contact-buttons boton-principal flex gap-2 items-center justify-center px-3 py-2 bg-[#e1e1dd] rounded-lg' rel="noreferrer">
        ...
        <ol className="relative border-s border-gray-200 dark:border-gray-700">                  
          <li className="mb-10 ms-4">
              <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-900"></div>
          ...
          <li className="mb-10 ms-4">
              ...
              <h3 className="text-lg font-semibold">Primer puesto</h3>
